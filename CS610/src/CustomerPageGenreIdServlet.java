 ...
 */
@WebServlet("/CustomerPageGenreIdServlet")
public class CustomerPageGenreIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CustomerPageGenreIdServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		*/
		...
		// Response Page
		request.getRequestDispatcher("CustomerPageGenreId.jsp").forward(request,
				response);
	}
